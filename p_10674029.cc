...
}adminis;//Variable of student type
...
cout<<"5.Print academic record of student\n";
cin>>choice;
...
case '4': //Student
 {
while(4)//inner loop-1
{
system("cls");//Clear screen
//Level-2 display
cout<<"\t\t\t ADMINISTRATOR \n\n\n";
cout<<"Enter your choice: "<<endl;
cout<<"1.Create new entry for student/teacher/course\n";
cout<<"2.Find and display entry\n";
cout<<"3.Go back to main page\n";
cout<<"4.Delete entry(student/teacher/staff)\n";
cout<<"5.Assign student to course\n";
cout<<"6.Record student grade\n";
cout<<"7.Print academic record of student\n";
cout<<"8.Delete entry(course)\n";
cin>>choice;
